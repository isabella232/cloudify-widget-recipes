...
def tomcatScript="${context.serviceDirectory}/runTomcat.sh"
				
builder.sequential {	
    echo(message:"mysql_start.groovy: Running ${tomcatScript} on ${currOsName} ...")
	exec(executable:"${tomcatScript}", osfamily:"${currOsName}",failonerror: "false")
}	
